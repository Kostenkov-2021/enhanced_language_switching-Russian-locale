...
addon_info = {
	...
	"addon_name": "enhancedLanguageDetection",
	...
	"addon_url": "https://github.com/Emil-18/enhanced_language_switching",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/Emil-18/enhanced_language_switching",
...
pythonSources = ["addon/globalPlugins/enhancedLanguageDetection/*.py"]
