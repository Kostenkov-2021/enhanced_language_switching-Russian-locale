...
* Скачать: [Стабильная версия](https://github.com/Emil-18/enhanced_language_switching/releases/download/v1.2.5/enhancedLanguageDetection-1.2.5.nvda-addon).
...
* Количество слов, необходимое для переключения языка.
	Это числовое поле редактирования, которое позволяет выбрать минимальное количество слов, необходимое для активации функции определения языка. Если произносимый текст содержит меньше слов, чем это значение, дополнение будет работать так, как будто оно отключено
...
* Количество слов, необходимое для переключения языка.
	Это числовое поле для редактирования, которое позволяет выбрать минимальное количество слов, необходимое для активации функции определения языка. Если произносимый текст содержит меньше слов, чем это значение, надстройка будет работать так, как будто она отключена
* Определяемые языки:
...
Эта версия была создана @heath-toby.

* Добавлена совместимость с NVDA 2026.1.
* Добавлена настройка, позволяющая указать минимальное количество слов, необходимое для активации дополнения.

### Версия 1.2.3

* Исправлена ошибка, из-за которой речь останавливалась или NVDA воспроизводил звук ошибки, когда язык не был выбран

### Версия 1.2.2

* Исправлена ошибка, из-за которой по умолчанию проверялись все языки, поддерживаемые lingua

### Версия 1.2.1

* Обновлён перевод на русский язык, спасибо Kostenkov-2021
